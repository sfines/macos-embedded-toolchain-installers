#!/bin/zsh
#
# install_microbit_v2_platformio_dev.sh
# Install the PlatformIO toolchain for the micro:bit v2 on macOS.
#
# Target board: BBC micro:bit V2 (Nordic nRF52833)
# PlatformIO platform: nordicnrf52
# PlatformIO board ID: bbcmicrobit_v2
#
# Usage:
#   ./install_microbit_v2_platformio_dev.sh
#
...
# ---------------------------------------------------------------------------
# 8. Install the Nordic nRF52 platform
# ---------------------------------------------------------------------------
info "Installing the nordicnrf52 platform..."
pio platform install nordicnrf52
ok "nordicnrf52 platform installed."
...
The micro:bit v2 has an on-board CMSIS-DAP/DAPLink interface. PlatformIO uses
it automatically for upload and debugging. On modern macOS no separate driver is
required; PlatformIO ships the necessary tools.
...
echo
ok "micro:bit v2 PlatformIO toolchain installed successfully!"
echo
info "Next steps:"
echo "  1. Open a new terminal or run: source ~/.zshrc"
echo "  2. Create a micro:bit v2 project:"
echo "       pio project init --board bbcmicrobit_v2 --project-dir ~/microbit-v2-blink"
echo "  3. Build/flash/monitor:"
echo "       cd ~/microbit-v2-blink"
echo "       pio run"
